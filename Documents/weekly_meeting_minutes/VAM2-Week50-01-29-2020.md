...
| 1. | Roll Call | NA |
| 2. | Introductions |  | 
| 3. | Key Points </br>  1. high level summaries will be presented for:  </br>  a. Management  </br>  b. Technical  </br> </br> 2. Agenda for each track:  </br>  i. Overview of progress  </br> ii. What was accomplished in the prior week </br> iii. What is planned for the coming week </br>  iv.	Are we on track to meet deadlines (display GANTT chart) | 1. Discussed the dashboard and its use to track deliverables on the project. </br> </br> 2. Items completed last week: <ul> <li> Received concurence for IOC testing </li> <li> Gathered information need to compile the Security Vulnerability Report </li> <li> Confirmed that the project is on track deliver all deliverables by the end on the PoP </li> </ul> 
 | 4. | Next Steps| 1. Compile the Final Capacity, Performance, and Scalability Assessment for National Deployment 2. Compile the Security Vulnerability Report 3. Working towards closing the contract | 
| 5. | Adjourned: | 4:15 pm |
