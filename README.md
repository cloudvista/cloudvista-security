...
Key deliverables were Authority to Operate (ATO) and Initial Operating Capability (IOC) of VistA in the VA Enterprise Cloud. which incorporate all U.S. GovCloud (Fedramp HIGH), Federal (NIST, HIPAA, FISMA), VA (Riskvision) and DOD (eMASS) security, reliability, and performanc certifications.
