...
Cloud VistA Zero Trust Security provides a comprehensive security for all clients, all applications, all endpoints, and all transactions of all Cloud VistA systems.  In addition Cloud VistA has is certified and authorized to operate to all VA and DoD security standards, including U.S. GovCloud (Fedramp HIGH); Federal (NIST, FISMA); HHS (HIPAA); FIPS 140.2 (TLS encryption); VA (Riskvision; 425 controls); DOD (eMASS; 1600+ controls) 
